...
<?/*if(IsModuleInstalled("idea")):?>
    <?$APPLICATION->IncludeComponent("bitrix:idea.popup", "", array(
            ...
            "PATH_IDEA_INDEX" => "/site_ek/about/idea/",
            "PATH_IDEA_POST" => "/site_ek/about/idea/#post_id#/",
            "BUTTON_COLOR" => "",
            "POST_BIND_STATUS_DEFAULT" => "#IDEA_BIND_STATUS_DEFAULT#",
            "FORGOT_PASSWORD_URL" => "/site_ek/login/?forgot_password=yes",
            "REGISTER_URL" => "/site_ek/login/?clear_cache=Y",
            "CATOGORIES_CNT" => "4",
